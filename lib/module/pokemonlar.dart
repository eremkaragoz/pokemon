...
//
//     final pokemonlar = pokemonlarFromJson(jsonString);

import 'dart:convert';

Pokemonlar pokemonlarFromJson(String str) => Pokemonlar.fromJson(json.decode(str));

String pokemonlarToJson(Pokemonlar data) => json.encode(data.toJson());
...
class Pokemonlar {
  ...
  factory Pokemonlar.fromJson(Map<String, dynamic> json) => Pokemonlar(
